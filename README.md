...
Список выпущенных версий — на странице релизов репозитория. Перед переходом загляните в раздел «Версии»: там написано, какая панель нужна.
...
Спасибо legiz-ru за [Orion](https://github.com/legiz-ru/Orion) (лицензия MIT) — за подход и за реализации кода.
